...
export type BusinessCategory = 'service_booking';
...
// Esto le dice a TypeScript: "La configuración de un negocio puede ser DE CITAS -O- DE RESTAURANTE"
export type BusinessConfig = ServiceBookingConfig;